...
class Food(models.Model):
    ...
    food_price = models.DecimalField(max_digits=10, decimal_places=2)  # Adjusted for larger values
...
class Drink(models.Model):
    ...
    drink_price = models.DecimalField(max_digits=10, decimal_places=2)  # Adjusted for larger values
